...
describe('UDPListener', ()  => {
    ...
    //         })
    //         it('connect-to-server', (done) =>{
    //             c.on('connect',  () => {  c.send('connect'); });
    //             c.connect(16000,'127.0.0.1');
    //             done();
    //         })
    //         it('connect-from-other-client', (done) =>{
    //             c1 = new udp.createSocket({type: "udp4", reuseAddr: true});
    //             c1.bind(16002, '127.0.0.1');
    //             c.send('connect2')
    //             c1.connect(16000,'127.0.0.1');
    //             done();
    //         })
    //         it('address',        () => { console.log(s);assert.equal(c.address().address, '127.0.0.1'); });
    //         it('port',    () => { assert.equal(c.address().port, 16001); });
    //         it('remote-address', () => { assert.equal(c.remoteAddress().address, '127.0.0.1'); });
    //         it('remote-port', () => { assert.equal(c.remoteAddress().port, 16000); });
    //     });
    ...
    //         });
    //         it('write2',  (done) => {
    //             c1.on('message', (msg, rinfo) => {
    //                 assert.equal(msg.toString(), 'asd');
    //                 done();
    //             })
    //             s.source.stream.write('asd');
    //         });
    //         it('server-stream-end',  () => {
    //             s.source.stream.removeAllListeners();
    //             c.removeAllListeners();
